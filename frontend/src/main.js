...
pluralCaseList.push( {plural: "workflowHists", pascal: "WorkflowHist"} )
pluralCaseList.push( {plural: "workflowHists", pascal: "WorkflowHist"} )

pluralCaseList.push( {plural: "rawData", pascal: "RawData"} )
pluralCaseList.push( {plural: "processedData", pascal: "ProcessedData"} )
pluralCaseList.push( {plural: "processedData", pascal: "ProcessedData"} )

pluralCaseList.push( {plural: "rawData", pascal: "RawData"} )
pluralCaseList.push( {plural: "rawData", pascal: "RawData"} )
pluralCaseList.push( {plural: "inferenceResults", pascal: "InferenceResult"} )
pluralCaseList.push( {plural: "inferenceResults", pascal: "InferenceResult"} )
